...
|__double__|带符号的双精度浮点数 floating scalar|
...
|__dvec2, dvec3, dvec4__|n维双精度浮点数向量 signed double vector|
...
![picture](http://wshxbqq-wshxbqq.stor.sinaapp.com/2016-08-08_16-15-35_329___2.png)
...
(还记得 __gl.vertexAttribPointer__ 这个函数吧)
